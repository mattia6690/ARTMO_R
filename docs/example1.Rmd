...
It is  recommended to build a folder structure before going in the deep analysis. This is very useful when the Output of the Model (such as Spatial Rasters) have to be connected to the Model output later.It is mandatory to manually connect the Model Output to the Table since ARTMO provides no logic Link in the MySQL tables to do so.
